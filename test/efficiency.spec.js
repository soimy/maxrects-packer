...
describe("Efficiency", () => {
    const AREA_CANDIDATES = [
        {
            name: "1024x2048:0",
            factory: () =>
                new MaxRectsPacker(1024, 2048, 0, {
                    smart: true,
                    pot: true,
                    square: false,
        ...
        },
        {
            name: "1024x2048:1",
            factory: () =>
                new MaxRectsPacker(1024, 2048, 1, {
                    smart: true,
                    pot: true,
                    square: false,
                    logic: PACKING_LOGIC.MAX_AREA
        ...
        },
        {
            name: "1024x1024:0",
            factory: () =>
                new MaxRectsPacker(1024, 1024, 0, {
                    smart: true,
                    pot: true,
                    square: false,
                    logic: PACKING_LOGIC.MAX_AREA
        ...
        },
        {
            name: "1024x1024:1",
            factory: () =>
                new MaxRectsPacker(1024, 1024, 1, {
                    smart: true,
                    pot: true,
                    square: false,
                    logic: PACKING_LOGIC.MAX_AREA
        ...
        },
        {
            name: "2048:2048:1",
            factory: () =>
                new MaxRectsPacker(2048, 2048, 1, {
                    smart: true,
                    pot: true,
                    square: false,
                    logic: PACKING_LOGIC.MAX_AREA
    ...
    test("combined best of", () => {
        ...
        let results = results1.map((scenario, scenarioIndex) =>
